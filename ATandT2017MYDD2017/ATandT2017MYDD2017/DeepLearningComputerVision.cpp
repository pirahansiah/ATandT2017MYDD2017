...
int main(int argc, char **argv)
{
	...
	String modelFile = "C:/opencv33/FarshidPirahanSiah/FarshidPirahanSiah/tensorflow_inception_graph.pb";
	String imageFile = "C:/opencv33/FarshidPirahanSiah/FarshidPirahanSiah/space_shuttle.jpg";
	String inBlobName = "input";// ".input";
	...
	String classNamesFile = "C:/opencv33/FarshidPirahanSiah/FarshidPirahanSiah/imagenet_comp_graph_label_strings.txt";   //parser.get<String>("c_names");
